      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <CardContent className="space-y-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{translations.loginForm.email}</FormLabel>
                <FormControl>
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    <Input placeholder="you@example.com" type="email" {...field} className="pl-10" />
                  </div>
                </FormControl>
                <FormMessage />
              </FormItem>
                ...
                <div className="flex justify-between items-center">
                  <FormLabel>{translations.loginForm.password}</FormLabel>
                   <Button variant="link" asChild className="p-0 h-auto text-xs">
                    <Link href="/forgot-password/authority">{translations.loginForm.forgotPassword}</Link>
                  </Button>
                </div>
                <FormControl>
                  <div className="relative">
        ...
        <CardFooter className="flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            <Button variant="link" asChild className="p-0 h-auto">
              <Link href="/register/authority">{translations.loginForm.registerHere}</Link>
            </Button>
          </p>
        </CardFooter>
      </form>
