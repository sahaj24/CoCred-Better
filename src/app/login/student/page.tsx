        ...
        <div className="w-full max-w-md">
          ...
          <Card className="relative w-full border border-gray-200 bg-white">
            <CardHeader className="text-center pb-6 pt-6">
              ...
              <CardTitle className="font-bold text-2xl text-gray-800 mb-2">{translations.loginPage.studentLoginTitle}</CardTitle>
              <CardDescription className="text-gray-600 text-sm">{translations.loginPage.studentLoginDescription}</CardDescription>
            </CardHeader>
            <StudentLoginForm />
          </Card>
        </div>
