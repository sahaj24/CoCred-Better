...
import { AuthorityForgotPasswordForm } from "@/components/auth/authority-forgot-password-form";
import { BookUser } from "lucide-react";
import Link from "next/link";
import { Button } from "@/components/ui/button";

export default function AuthorityForgotPasswordPage() {
  return (
