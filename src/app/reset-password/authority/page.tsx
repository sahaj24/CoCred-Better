...
import { AuthorityResetPasswordForm } from "@/components/auth/authority-reset-password-form";
import { BookUser } from "lucide-react";

export default function AuthorityResetPasswordPage() {
  return (
